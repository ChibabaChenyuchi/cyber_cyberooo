 ...
 <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url ('') }}">Cybertech Client Feedback Management System</a> 
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                       ...
                       <!--  <li {{ (Request::is('/') ? 'class="active"' : '') }}>
                            <a href="{{ url ('questions') }}"><i class="fa fa-menu fa-fw"></i> Question Lists</a>
                        </li> -->

                        <li {{ (Request::is('/') ? 'class="active"' : '') }}>
                            <a href="{{ url ('') }}"><i class="fa fa-dashboard fa-fw"></i> Question Lists</a>
                        </li>
                        <li {{ (Request::is('*survey_response') ? 'class="active"' : '') }}>
                            <a href="{{ url ('survey_response') }}"><i class="fa fa-bar-chart-o fa-fw"></i> Survey Response</a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li {{ (Request::is('*survey_details') ? 'class="active"' : '') }}>
                            <a href="{{ url ('survey_details') }}"><i class="fa fa-table fa-fw"></i> Survey Details</a>
                        </li>
                        <li {{ (Request::is('*dashboard') ? 'class="active"' : '') }}>
                            <a href="{{ url ('dashboard') }}"><i class="fa fa-table fa-fw"></i> Dashboard</a>
                        </li>
